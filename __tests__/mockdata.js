...
const getFakeUserResponse = { assignedTo: ["Unknown actor input"] };
// NOTE: Can also be this message:
// {"assignedTo":["Cannot assign to non-team member"]}
// Status code for both of the above:
const noUserStatusCode = 400;
const fakeUser = "nobody@test.com";
...
const getUsersResponse = [
  {
    ...
    user: {
      ...
      emails: [{ is_verified: true, id: "468229", email: userNames[0] }],
  ...
  },
  {
    ...
    user: {
      ...
      emails: [{ is_verified: true, id: "562269", email: userNames[1] }],
      avatar: { avatarUuid: null, avatarType: "letter_avatar" },
...
function assignIssueResponse(userName) {
  return {
    platform: "javascript",
